REM http://stackoverflow.com/a/20861377/1653040
...
set LIST=(mean2.dev www.mean2.dev)
::Set the ip of the domains you set in the list above
set mean2.dev=192.168.80.30
set www.mean2.dev=192.168.80.30
