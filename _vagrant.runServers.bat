vagrant ssh -- -t 'source ~/.nvm/nvm.sh; nvm use node; cd /vagrant/app/server; forever stopall; PORT=8081 forever start -v --minUptime 1000 --spinSleepTime 1000 -c "npm start" ./'
